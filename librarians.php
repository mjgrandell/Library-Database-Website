...
<h1 style="color:white">Librarians</h1>

<table style="color:white" class="center">
  <tr>
    <th style="color:white">Employee ID</th>
    <th style="color:white">Librarian First Name</th>
	<th style="color:white">Librarian Last Name</th>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
	...
	echo "<td>" . $row['l_fname'] . "</td>";
	echo "<td>" . $row['l_lname'] . "</td>";
	echo "<td>" . $row['l_phonenumber'] . "</td>";
	echo "</tr>";
  }
} else {
  echo "0 results";
