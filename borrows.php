...
<h1 style="color:white">Borrowed By</h1>

<table style="color:white" class="center">
  <tr>
    <th style="color:white">Title ID</th>
    <th style="color:white">Library Card ID</th>
	<th style="color:white">Borrow Date</th>
